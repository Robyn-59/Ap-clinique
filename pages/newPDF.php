...
$stats = $DB->prepare("select patient.Num_secu, patient.Nom_naissance, patient.Prenom, hospitalisation.Date_hospitalisation, hospitalisation.Heure_intervention, hospitalisation.Pre_admission, personnel.Nom, service.libelle from service
...
foreach($stats as $liste2){
    ...
    $pdf->Cell(0,10,"Liste des Pre-admissions pour le service : ".$liste2['libelle'],0,1,'C');
